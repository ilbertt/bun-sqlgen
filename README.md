...
in-process database (Postgres or SQLite) and emits the result types — so plain
`tsc` catches wrong property access and null-unsafety. Developed as a monorepo
powered by [Bun](https://bun.sh) and [Turborepo](https://turborepo.dev/).
